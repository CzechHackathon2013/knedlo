...
class IdnesParserTest extends FunSuite{
  ...
  test("idnes parser") {
    ...
    assert(article.description === "Světový rekordman Ashton Eaton hledá protivníka. V desetibojařském světě ho při obvyklé kondici\n                nemůže porazit nikdo, a tak se 25letý Američan rozhodl změnit disciplínu. Místo desetiboje bude závodit\n                na čtvrtce s překážkami. Zatím na rok. ")
  }
